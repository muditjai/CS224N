...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.label_placeholder = tf.placeholder(tf.int32, shape=(self.config.batch_size, self.config.n_classes), name='label')
        ### END YOUR CODE
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        train_op = tf.train.GradientDescentOptimizer(self.config.lr).minimize(loss=loss)
        ### END YOUR CODE
        return train_op
